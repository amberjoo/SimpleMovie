...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span7" >
        <div class="navbar" style="margin-top: 20px; ">
          <div class="navbar-inner">
            <ul class="nav">
              <li><a href="movies-inTheater.php">In Theater</a></li>
              <li  class="active"><a href="movies-comingSoon.php">Coming Soon</a></li>
            </ul>
          </div>
        </div><!-- /.navbar -->
        ...
        <div class="center">
          <!-- movie section-->
          <?php 
          $sql = "SELECT movies.id mid, title,runtime,plot,rating,studio,concat(d.fName,' ',d.lName) as director from movies,showtime,director d,directortomovie dm where movies.id = dm.movieId and dm.directorId = d.id and movies.id = showtime.movie and showtime.movie = movies.id and showtime.showtime > now() + 10000000 and showtime.showtime < now() + 100000000 order by showtime";
          $result = $conn->query($sql);

          $sql2 = "select count(*) number from movies,showtime,director d,directortomovie dm where movies.id = dm.movieId and dm.directorId = d.id and movies.id = showtime.movie and showtime.movie = movies.id and showtime.showtime > now() + 10000000 and showtime.showtime < now() + 100000000 order by showtime";
          ...
          {   
            echo "<div class='row-fluid border'>";
             ...
             echo "<p><b>Cast:&nbsp;&nbsp;&nbsp;Unknown</b></p>";
           }
         echo "</div>";
         echo "<div class='span3'>";
          echo "<p style='margin-top: 50px;'><a class='btn' href='tickets.php?movId=".$mid."' >View Details &raquo;</a></p>";
        echo "</div></div>";
      }
    ...
    <div class="row-fluid border">
      ...
      <div class="span3">
        <p style="margin-top: 50px;"><a class="btn" href="#" >View details &raquo;</a></p>
      </div>
    </div><!--/row-->
